...
class DataRecorderForm(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        "Light", input_class=tk.Spinbox, input_var=tk.DoubleVar(),
        ...
        "Temperature", input_class=tk.Spinbox, input_var=tk.DoubleVar(),
        ...
        "Plants", input_class=tk.Spinbox, input_var=tk.IntVar(),
        input_args={"from_":0, "to":20})

        self.inputs['Plants'].grid(row=0, column=0)

        self.inputs['Blossoms'] = LabelInput(
            plantInfo, "Blossoms", input_class=tk.Spinbox,
            input_var=tk.IntVar(),
        ...
        "Fruit", input_class=tk.Spinbox, input_var=tk.IntVar(),
        input_args={"from_":0, "to":1000})

        self.inputs['Fruit'].grid(row=0, column=2)

        self.inputs['Max Height'] = LabelInput(plantInfo,
        "Max Height", input_class=tk.Spinbox, input_var=tk.DoubleVar(),
        ...
        "Min Height", input_class=tk.Spinbox, input_var=tk.DoubleVar(),
        input_args={"from_":0, "to":1000, "increment":0.01})

        self.inputs['Min Height'].grid(row=1, column=1)

        self.inputs['Median Height'] = LabelInput(plantInfo,
        "Median Height", input_class=tk.Spinbox, input_var=tk.DoubleVar(),
        input_args={"from_":0, "to":1000, "increment":0.01})
